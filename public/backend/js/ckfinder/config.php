...
$_SESSION['CKFINDER'] = array(
    ...
    'baseDir'               => $_SERVER['DOCUMENT_ROOT'].'/static/uploads/',
    'IsAuthorized'          => true,
...
$_SESSION['CKFINDER']['ResourceType'][] = array(
    ...
    'maxSize'           => '50M',
    'allowedExtensions' => 'jpeg,jpg,mov,mp3,mp4,pdf,png,zip,html,css,js,scss,xlsx,xls',
    'deniedExtensions'  => ''
);
$_SESSION['CKFINDER']['ResourceType'][] = Array(
    'name' => 'Images',
    'url' => $_SESSION['CKFINDER']['baseUrl'] . 'images',
    'directory' => $_SESSION['CKFINDER']['baseDir'] . 'images',
    'maxSize' => "50M",
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,html,css,js,scss',
    'deniedExtensions' => ''
);
