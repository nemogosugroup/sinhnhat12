...
<script>
import Tinymce from "@backend/components/Tinymce";
import MDinput from "@backend/components/MDinput";
import Sticky from "@backend/components/Sticky";
import Ckfinder from '@backend/components/Ckfinder'
import { validURL } from "@backend/utils/validate";
import { fetchArticle } from "@backend/api/article";
import { searchUser } from "@backend/api/remote-search";
import Warning from "./Warning";
import Upload from "@backend/components/Upload/SingleImage4";
import {
    CommentDropdown,
    PlatformDropdown,
    SourceUrlDropdown,
