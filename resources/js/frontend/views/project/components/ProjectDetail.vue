...
<script>
import Tinymce from "@frontend/components/Tinymce";
import MDinput from "@frontend/components/MDinput";
import Sticky from "@frontend/components/Sticky";
import Ckfinder from '@frontend/components/Ckfinder'
import { validURL } from "@frontend/utils/validate";
import { fetchArticle } from "@frontend/api/article";
import { searchUser } from "@frontend/api/remote-search";
import Warning from "./Warning";
import Upload from "@frontend/components/Upload/SingleImage4";
import {
    CommentDropdown,
    PlatformDropdown,
    SourceUrlDropdown,
